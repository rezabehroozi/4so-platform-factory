...
`OPENCHOREO_REFERENCE_ADOPTION_V1` is the executable architecture decision for selective OpenChoreo adoption. The reviewed baseline is OpenChoreo v1.3.x at upstream commit `1aeed89856d088dc5160c0f3eaa39796d4a93611` (reviewed 2026-09-23). OpenChoreo is a reference implementation for application-platform abstractions, multi-cluster agent/gateway transport, MCP authorization and AI/operational-insight patterns; it is not another 4SO source of truth.
