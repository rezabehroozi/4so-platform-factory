...
def validate_product_api_contract(root: Path, errors: list[tuple[str,str]], expected_route_count: int) -> int:
    ...
    for marker in ('Code generated by scripts/generate_product_api_contract.py; DO NOT EDIT.',f'ProductAPIContractAuthority = "PRODUCT_API_CONTRACT_AUTHORITY_V1"',f'ProductAPIContractDigest = "{digest}"',f'ProductAPIRouteCount = {len(rows)}','ResourceScope:','ResourceScopeStatus:'):
        if marker not in go:
