...
READLIKE_POST={
 ...
 '/api/v1/edge/boot-attestations/assess','/api/v1/edge/local-ai/profiles/validate','/api/v1/application-platform/resolve','/api/v1/application-platform/openchoreo/assessment',
}
ADMIN_MARKERS=(
