...
func TestMCPRouteParityRegistryHasNoUnclassifiedStableRoute(t *testing.T) {
	...
	if registry.RouteCount != 348 {
		t.Fatalf("unexpected stable route count: %d", registry.RouteCount)
	}
	if registry.Counts["tool-read"] != 167 || registry.Counts["tool-operate"] != 68 || registry.Counts["tool-admin"] != 73 || registry.Counts["security-excluded"] != 40 {
