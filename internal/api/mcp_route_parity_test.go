...
func TestMCPRouteParityRegistryHasNoUnclassifiedStableRoute(t *testing.T) {
	...
	if registry.RouteCount != 345 {
		t.Fatalf("unexpected stable route count: %d", registry.RouteCount)
	}
	if registry.Counts["tool-read"] != 165 || registry.Counts["tool-operate"] != 67 || registry.Counts["tool-admin"] != 73 || registry.Counts["security-excluded"] != 40 {
