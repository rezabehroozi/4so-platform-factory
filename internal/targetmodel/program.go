...
func blockerClosureClass(blocker string) string {
	classes := map[string]string{
		...
		"OPENCHOREO_EXACT_RUNTIME_ACQUISITION_PENDING":     "external-byte-acquisition",
